...
flags.DEFINE_float('adam_alpha', 0.0001, 'alpha in Adam optimizer')
...
flags.DEFINE_float('learning_rate_anneal', 0.9, 'anneal the learning rate. 0 for no annealing.')
flags.DEFINE_integer('learning_rate_anneal_trigger', 0, 'trigger of learning rate anneal')
flags.DEFINE_integer('learning_rate_anneal_interval', 5000, 'interval of learning rate anneal')

# hps (device)
flags.DEFINE_integer('gpu', 0, 'GPU ID (negative value indicates CPU)')

# hps (I/O)
flags.DEFINE_string('npz_path', 'dataset.npz', 'path to dataset npz file')
flags.DEFINE_string('out', 'result', 'Directory to output the result')
flags.DEFINE_integer('snapshot_interval', 5000, 'Interval of snapshot')
flags.DEFINE_integer('evaluation_interval', 10000, 'Interval of heavy evaluation')
flags.DEFINE_integer('evaluation_sample_interval', 100, 'Interval of evaluation sampling')
flags.DEFINE_integer('display_interval', 10, 'Interval of displaying log to console')
